<template>
  <BoardLayout>
    <q-card-section class="row justify-center">
      <div class="col-11 col-sm-6 text-grey-8">
        <h4 style="text-align: center"><b>TERMS AND CONDITIONS</b></h4>
        <!-- <p>Last updated: 2022-12-31</p> -->
        <p>1. <b>Introduction</b></p>
        <p>Welcome to <b>PettyCash</b> (“Company”, “we”, “our”, “us”)!</p>
        <p>
          These Terms of Service (“Terms”, “Terms of Service”) govern your use
          of our website located at <b>pettycash.com</b> (together or
          individually “Service”) operated by <b>PettyCash</b>.
        </p>
        <p>
        ...
        <p>
          ...
          <b>redflux86@gmail.com</b> so we can try to find a solution. These
        ...
        <p>
          PettyCash has the right but not the obligation to monitor and edit all
          Content provided by users.
        </p>
        <p>
          In addition, Content found on or through this Service are the property
          of PettyCash or used with permission. You may not distribute, modify,
        ...
        <p>
          ...
          property of PettyCash and its licensors. Service is protected by
          ...
          without the prior written consent of PettyCash.
        </p>
        ...
        <p>
          ...
          to redflux86@gmail.com, with the subject line: “Copyright
        ...
        <p>
          You can contact our Copyright Agent via email at redflux86@gmail.com.
        </p>
        <p>12. <b>Error Reporting and Feedback</b></p>
        <p>
          You may provide us either directly at redflux86@gmail.com or via third
        ...
        <p>
          ...
          that are not owned or controlled by PettyCash.
        </p>
        <p>
          PettyCash has no control over, and assumes no responsibility for the
        ...
        <p style="margin-top: 5em; font-size: 0.7em">
          ...
          <a href="https://policymaker.io/terms-and-conditions/"
            >Terms of Service</a
          >
          were created for <b>pettycash.com</b> by
          <a href="https://policymaker.io">PolicyMaker.io</a> on 2023-01-31.
        </p>
      </div>
    </q-card-section>
  </BoardLayout>
