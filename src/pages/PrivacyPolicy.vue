  ...
  <BoardLayout>
    <q-card-section class="row justify-center">
      <div class="col-11 col-sm-6 text-grey-8">
        <h4 style="text-align: center"><b>PRIVACY POLICY</b></h4>
        <p>Effective date: 2022-12-27</p>
        <p>1. <b>Introduction</b></p>
        <p>Welcome to <b> pettycash</b>.</p>
        <p>
          <b>pettycash</b> (“us”, “we”, or “our”) operates
          <b>pettycash.com</b> (hereinafter referred to as <b>“Service”</b>).
        </p>
        <p>
          Our Privacy Policy governs your visit to <b>pettycash.com</b>, and
        ...
        <p>
          <b>SERVICE</b> means the pettycash.com website operated by pettycash.
        </p>
        <p>
        ...
        <p>pettycash uses the collected data for various purposes:</p>
        ...
        <p>
          pettycash will take all the steps reasonably necessary to ensure that
        ...
        <p>
          ...
          please send your request(s) by email: <b>redflux86@gmail.com</b>.
        </p>
        <p>
        ...
        <p>
          ...
          by email: <b>redflux86@gmail.com</b>.
        </p>
        <p style="margin-top: 5em; font-size: 0.7em">
          This
          <a href="https://policymaker.io/privacy-policy/">Privacy Policy</a>
          was created for <b>pettycash.com</b> by
          <a href="https://policymaker.io">PolicyMaker.io</a> on 2022-12-27.
        </p>
      </div>
    </q-card-section>
  </BoardLayout>
